...
from util import convert_message, full_screen_shot
...
# Todo- os.getenv("APP_KEY")
# username.send_keys("18344")
# password.send_keys("Tlftlrks2")
...
# Todo- os.getenv("APP_KEY")
# member_number_1.send_keys("18344")
# member_number_2.send_keys("18829")
...
for option in options:
    # print("Option value:", option.get_attribute("value"))
...
for day in dates_list:
    ...
    try:
        if do_reservation:
            ...
            # reserve at 8:00 PM
            if first_row_time_text in ["07:00 PM", "08:00 PM", "09:00 PM"]:
...
with open("report_status.txt", "a") as file:
    file.write('---Result---' + "\n")
